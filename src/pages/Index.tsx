    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="access-button flex items-center gap-2">
          <Activity className="w-4 h-4" style={{ color: 'black' }} />
        ...
        <Card className="access-card">
          <CardHeader>
            <CardTitle className="text-base flex items-center gap-2" style={{
              ...
              <Radar className="w-5 h-5" style={{ color: 'black' }} />
              وضعیت سیستم‌ها
            </CardTitle>
          </CardHeader>
        ...
        <Card className="access-card">
          <CardHeader>
            <CardTitle className="text-base flex items-center gap-2" style={{
              ...
              <Brain className="w-5 h-5" style={{ color: 'black' }} />
              عملیات سریع
            </CardTitle>
          </CardHeader>
          <CardContent className="grid grid-cols-2 gap-4">
            <div className="dashboard-card" onClick={handleRFScan}>
              <Radio className="w-8 h-8 mb-2" style={{ color: 'black' }} />
            ...
            <div className="dashboard-card" onClick={handleLocalScan}>
              <Activity className="w-8 h-8 mb-2" style={{ color: 'black' }} />
              <h3 className="text-sm mb-1" style={{
                fontFamily: 'BNazanin',
                fontWeight: 'normal',
                color: 'black'
            ...
            <div className="dashboard-card" onClick={handleMapView}>
              <Map className="w-8 h-8 mb-2" style={{ color: 'black' }} />
              <h3 className="text-sm mb-1" style={{
                fontFamily: 'BNazanin',
                fontWeight: 'normal',
                color: 'black'
            ...
            <div className="dashboard-card" onClick={handleAIAnalysis}>
              <Brain className="w-8 h-8 mb-2" style={{ color: 'black' }} />
              <h3 className="text-sm mb-1" style={{
                fontFamily: 'BNazanin',
                fontWeight: 'normal',
                color: 'black'
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div>
              ...
              <span style={{ color: 'black' }}>{realSystemData.cpuUsage}%</span>
            </div>
            <div>
              <span style={{ color: '#555' }}>Memory: </span>
              <span style={{ color: 'black' }}>{realSystemData.memoryUsage} MB</span>
            </div>
            <div>
              <span style={{ color: '#555' }}>Network: </span>
              <span style={{ color: 'black' }}>{realSystemData.networkStatus ? 'متصل' : 'قطع'}</span>
            </div>
            <div>
              <span style={{ color: '#555' }}>Hardware: </span>
              <span style={{ color: 'black' }}>{realSystemData.hardwareConnected} دستگاه</span>
            </div>
          </div>
        </CardContent>
      </Card>
